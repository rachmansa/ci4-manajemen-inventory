        ...
        <div class="app-brand demo">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- TRANSAKSI INTERNAL-->
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">TRANSAKSI INTERNAL</span>
            </li>
            <li class="menu-item">
              <a href="/barang-lab" class="menu-link">
                <i class="menu-icon tf-icons fa fa-network-wired"></i>
                <div data-i18n="Basic">Barang Lab CAT</div>
              </a>
            </li>
            <li class="menu-item">
