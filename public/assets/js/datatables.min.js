 ...
 *   https://datatables.net/download/#bs5-5.3.0/dt-2.2.2/af-2.7.0/b-3.2.2/b-html5-3.2.2/b-print-3.2.2/date-1.5.5/fc-5.0.4/fh-4.0.1/r-3.0.3/sc-2.4.3/sb-1.8.2/sp-2.3.3/sl-3.0.0/sr-1.4.1
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, DataTables 2.2.2, AutoFill 2.7.0, Buttons 3.2.2, HTML5 export 3.2.2, Print view 3.2.2, DateTime 1.5.5, FixedColumns 5.0.4, FixedHeader 4.0.1, Responsive 3.0.3, Scroller 2.4.3, SearchBuilder 1.8.2, SearchPanes 2.3.3, Select 3.0.0, StateRestore 1.4.1
 */
